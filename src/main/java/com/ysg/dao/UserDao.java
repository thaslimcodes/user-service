...
public interface UserDao extends CrudRepository<User, String> {
    ...
    @Query(" SELECT r.id FROM User u, Role r, UserRole ur, App a WHERE u.id = ur.id.userId AND r.id = ur.id.roleId AND u.email = :email AND a.id = ur.id.appId AND a.id = :app ")
    ...
    List<String> getEmailIdsForAppRole(@Param("app") String app, @Param("role") String role);
    ...
    List<String> getEmailIdsForAppRoleCity(@Param("app") String app, @Param("role") String role, @Param("city") String city);
